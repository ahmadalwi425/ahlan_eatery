...
@section('content')
    ...
    <form method="post" action="{{ route('masakan.update', $masakan->id) }}" id="myForm">
        ...
        <div class="form-group">
            ...
            <input type="text" name="id" class="form-control" id="id" value="{{ $masakan->id }}" aria-
                describedby="id">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama_masakan" class="form-control" id="nama_masakan"
                value="{{ $masakan->nama_masakan }}" aria-describedby="nama_masakan">
        </div>
        <div class="form-group">
            <label for="harga">Harga</label>
            <input type="harga" name="harga" class="form-control" id="harga" value="{{ $masakan->harga }}"
                aria-describedby="harga">
        </div>
        <div class="form-group">
            <label for="status">Status</label>
            <input type="status" name="status" class="form-control" id="status"
                value="{{ $masakan->status }}" aria-describedby="status">
        </div>

...
(5, '2021_09_13_053923_create_masakan_table', 1),
...
CREATE TABLE `order` (
  ...
  `status_order` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `harga` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `masakan`
  ADD CONSTRAINT `masakan_ibfk_1` FOREIGN KEY (`id_jenis`) REFERENCES `jenis_masakan` (`id`) ON UPDATE CASCADE;
